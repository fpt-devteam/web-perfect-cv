          ...
          {isLoadingProjects ? (
            ...
            <div className="space-y-4">
              {projects.map(project => (
                <div
                  key={project.id}
                  className="flex items-start justify p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g. KOI Auction Website" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
