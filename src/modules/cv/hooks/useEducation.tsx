...
import { listEducations, createEducation, updateEducation, deleteEducation } from '@/modules/cv/services/cv.services';
import type { CreateCVEducationRequest, UpdateCVEducationRequest, CVEducationResponse } from '@/modules/cv/types/cv.types';
...
export function useCreateEducation({ cvId }: { readonly cvId: string }) {
    ...
    return useMutation({
        ...
        onMutate: async (newEducation) => {
            ...
            const previousEducations = queryClient.getQueryData<CVEducationResponse[]>(genEducationsKey(cvId));
            ...
            if (previousEducations) {
                ...
                queryClient.setQueryData<CVEducationResponse[]>(
                    ...
                    [...previousEducations, optimisticEducation]
                );
            }
