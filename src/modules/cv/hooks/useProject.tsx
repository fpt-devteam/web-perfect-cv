...
import { listProjects, createProject, updateProject, deleteProject } from '@/modules/cv/services/cv.services';
import type { CreateCVProjectRequest, UpdateCVProjectRequest, CVProjectResponse } from '@/modules/cv/types/cv.types';
...
export function useCreateProject({ cvId }: { readonly cvId: string }) {
    ...
    return useMutation({
        mutationFn: (projectData: CreateCVProjectRequest) =>
            createProject({ cvId, projectData }),
